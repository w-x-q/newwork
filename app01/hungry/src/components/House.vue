 ...
 * @LastEditors: losn
 * @LastEditTime: 2019-11-14 00:24:25
 -->
...
<template>
  <div>
    <div class="house">
          ...
          <div id="div3" class="food_delivery">
            <span class="sendQuick">支付方式</span>
            <img  class="photo" src="../assets/photo/jtyou.png" alt />
            <span  class="smallSpan" v-on:click="select_pay_type">{{pay_type}}</span>
          </div>

            <mt-picker class="pop_windows" ref="picker" :type="select_type" :slots="slots" @change="onValuesChange" v-show="isShow"></mt-picker>
